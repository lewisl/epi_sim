...
inline constexpr std::string_view parameters_help = R"TAG(Everything about parameters.
)TAG";

inline constexpr std::string_view socialparameters_help = R"TAG(All about social parameters.
)TAG";

inline constexpr std::string_view config_help = R"TAG(This is the config help.
)TAG";
